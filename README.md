...
> **0.8.3游戏版本更新简述：**<br>除了移除7首The Friday Prophets相关版权音乐外，其余更新均为语法&用词修正、代码位置变动等(汉化均已跟进)，没什么重要更新。
- ???
...
- 添加&修改共252张图片翻译：<br>(主菜单及部分界面功能按钮、数学考试、2D艺术封面、滑滑、叫鸡、手机应用界面、特殊渲染鉴赏功能按钮、教程/提示)</details>
