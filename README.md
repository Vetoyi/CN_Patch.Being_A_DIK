...
# :o:前言
> 没什么好说的了，未来汉化补丁均只在GitHub上更新，若有我发在Steam上的其它汉化我也会链接过来这边。鉴于B站会秋后算账封禁，决定只把原来的专栏随便改下作为补丁入口，之后不再更新实质性内容，即可能不会再有任何黄油相关投稿了，反正如有需要且有条件的也能通过入口专栏找到这里。对于各类私信及评论，如果是本说明有涉及且已给出有效解决方案，将不再给予回复，本说明已经写的极其详细了，如果还看不懂显然也没有再沟通的必要了，截至专栏封禁为止，我基本回复过所有人的问题，但今后不打算再这么费力了，如果真的想用汉化就请仰赖自己吧真的不难，别太指望能等到我来帮你；但相对的，对于有价值的bug等补丁问题反馈，也请各位主动自发留言，你的回复或许正是未来更多玩家改善游戏体验的契机，如有机会我也会在以后统一收集并在新版补丁中尽量修复。以上，祝各位游戏愉快！
