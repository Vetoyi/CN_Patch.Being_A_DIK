...
## :warning:【重要:bangbang:】如果你没有购买安装[Being A DIK - Season2 DLC](https://store.steampowered.com/app/1215820)，请在安装完汉化补丁后，根据以下步骤删除部分补丁文件，否则游戏将会存在报错；或者你也可以直接购买[Being A DIK - Season2 DLC](https://store.steampowered.com/app/1215820)，并在安装完DLC后再重新安装一次补丁，游戏即可正常游玩。
